...
Script Purpose:
    ...
    - Uses the 'BULK INSERT' command to data from csv files to bronze tables.
...
BEGIN
	...
	BEGIN TRY
		...
		PRINT '>> Inserting Data Into: bronze.erp_cust_az1';
		BULK INSERT bronze.erp_cust_az1
